    ...
    <section id="peta" class="about-info-area section-gap">
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA9dahisogvUETH5i0ddwmLj75xL9lEqSo&callback=initMap "></script>
          ...
          <script type="text/javascript">
            ...
            function initialize() {
              ...
              var mapOptions = {
                zoom: 18,
                center: new google.maps.LatLng(-8.625251, 115.169031),
