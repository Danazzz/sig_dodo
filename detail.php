    ...
    <div class="row">
        ...
        <div class="panel panel-info panel-dashboard">
          ...
          <div class="panel-body">
            ...
            <table class="table table-hover table-bordered">
              ...
              <?php
              $no=1;
              $sql=mysqli_query($koneksi,"SELECT * FROM pembayaran where idpelanggan = '$id'") or die(mysqli_error($koneksi));
      ...
      <div class="col-md-5" data-aos="zoom-in">
        <div class="panel panel-info panel-dashboard">
          ...
          <div class="panel-body">
            <a href="https://www.google.com/maps/dir/?api=1&origin=-8.621166,115.167719&destination=<?= $lat; ?>,<?= $long; ?>">
